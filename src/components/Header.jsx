    ...
    return (
        <>
            <div className="h-[100vh] flex flex-col justify-center items-center text-center bg-cover bg-center"
                ...
                <NavLink to="/meropriyatsiya" className='bg-[#8c0000] text-white text-[12px] sm:text-[14px] md:text-[15px] px-[20px] sm:px-[30px] md:px-[40px] py-[11px] sm:py-[14px] md:py-[15px] font-bold cursor-pointer transition-all duration-300 hover:bg-[#a00000]'>
