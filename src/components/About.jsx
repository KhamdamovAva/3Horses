...
function About() {
  return (
    <section className='py-[50px] container m-auto'>
      ...
      <div className="">
          <div className='flex flex-col items-center m-auto p-4 md:items-start md:justify-between md:flex-row gap-4 w-full mb-[50px]'>
            <p className="text-[20px] font-sans w-full md:w-[730px]">Клуб «Три коня» — это уникальное пространство для студентов и выпускников МГТУ им. 
            ...
            <img src={image1} alt="classroom" className="max-w-[350px] px-[30px] md:px-0 md:mr-[30px]"/>
          </div>
          <div className='flex flex-col items-center m-auto p-5 md:justify-start md:flex-row gap-4 w-full'>
            <p className='text-[20px] font-sans w-full md:w-[750px] md:mr-[100px]'>Концепция клуба: <br />
            ...
            <img src={image2} alt="students" className='max-w-[300px]'/>
          </div>
        </div>
    </section>
  )
